...
/* Cette fonction lance une nouvelle partie de mastermind en affectant à chaque composante de la combinaison secrète une valeur tirée au hasard dans
   {COULEUR_MIN ,..., COULEUR_MAX} */
